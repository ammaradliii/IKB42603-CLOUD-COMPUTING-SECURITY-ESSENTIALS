...
![Task 1 evidence: unauthenticated request rejected and valid credentials accepted](Evidence-redacted/redacted-1.png)
...
![Task 2 evidence: valid TOTP accepted and invalid code rejected](Evidence-redacted/redacted-2.png)
...
![Task 3 evidence: RBAC binding and allowed/denied authorization checks](Evidence-redacted/redacted-3.png)
...
![Task 4 evidence: front tier blocked from database and application tier allowed](Evidence-redacted/redacted-4.png)
...
![Task 5 evidence: INPUT policy DROP with explicit HTTPS and loopback allows](Evidence-redacted/redacted-5.png)
...
![Task 6 evidence: hardened container runs non-root, read-only, with all capabilities dropped](Evidence-redacted/redacted-6.png)
